...
export default function Home() {
  ...
  return (
    <main className="flex-1 flex flex-col items-center w-full bg-[#fbfbfd]">
            ...
            {!showLeadForm && (
              <div className="flex flex-col sm:flex-row items-center gap-4 bg-black/40 backdrop-blur-md rounded-3xl sm:rounded-full p-2 sm:pl-6 border border-white/10 shadow-2xl animate-blur-in-up [animation-delay:200ms]">
                ...
                <button 
                  ...
                  className="bg-[#ccb9b6] hover:bg-[#b8a6a3] text-wine text-sm font-semibold px-6 py-2.5 rounded-full transition-all duration-300 shadow-sm cursor-pointer"
                >
                  Quero planejar
                </button>
              </div>
      ...
      <section id="metodo" className="w-full bg-[#fbfbfd] py-28 md:py-36 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-24">
          
          <div className="w-full md:w-5/12 bg-white rounded-[32px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-black/[0.02] flex flex-col group">
            <div className="w-full aspect-[4/5] relative overflow-hidden bg-[#fbfbfd]">
          ...
          <div className="w-full md:w-7/12 flex flex-col items-start">
            ...
            <div className="grid grid-cols-2 gap-4 w-full pt-4">
              <div className="p-4 rounded-2xl bg-white border border-black/[0.04]">
                <div className="text-2xl font-bold text-wine tracking-tight">USP & UNIFESP</div>
                <div className="text-xs text-chumbo-light mt-1">Formação de Excelência</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-black/[0.04]">
                <div className="text-2xl font-bold text-wine tracking-tight">Direito</div>
                <div className="text-xs text-chumbo-light mt-1">Foco na Segurança do Paciente</div>
              </div>
            </div>
          </div>
      ...
      <section id="faq" className="w-full py-28 md:py-36 px-4 bg-[#310f0e] text-white">
